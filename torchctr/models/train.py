...
input_path = "python/recommendation/census_148d_train.libsvm.tmp"
...
# model.save("python/recommendation/savedmodules/DeepAndWide-model.pt")
# model = torch.jit.load("python/recommendation/savedmodules/DeepAndWide-model.pt")
